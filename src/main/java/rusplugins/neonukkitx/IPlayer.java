...
import rusplugins.neonukkitx.permission.ServerOperator;
 ...
 * @see rusplugins.neonukkitx.Player
 * @see rusplugins.neonukkitx.OfflinePlayer
 */
public interface IPlayer extends ServerOperator, Metadatable {
     ...
     * <p>
     * 如果是在线的玩家，这个函数只会返回登录名字。如果要返回显示的名字，参见{@link rusplugins.neonukkitx.Player#getDisplayName}<br>
     * Notice that this will only return its login name. If you need its display name, turn to
     * {@link rusplugins.neonukkitx.Player#getDisplayName}
     *
     ...
     * @see rusplugins.neonukkitx.Server#isWhitelisted
     */
     ...
     * @see #isWhitelisted
     * @see rusplugins.neonukkitx.Server#addWhitelist
     * @see rusplugins.neonukkitx.Server#removeWhitelist
     */
     ...
     * @see rusplugins.neonukkitx.Server#getPlayerExact
     */
    Player getPlayer();
