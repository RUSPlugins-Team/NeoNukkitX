 ...
 * @see rusplugins.neonukkitx.command.CommandExecutor#onCommand
 */
public interface CommandSender extends Permissible {
     ...
     * @see rusplugins.neonukkitx.utils.TextFormat
     */
     ...
     * @see rusplugins.neonukkitx.Player#getName()
     * @see rusplugins.neonukkitx.command.ConsoleCommandSender#getName()
