package rusplugins.neonukkitx.command;

import rusplugins.neonukkitx.Server;
import rusplugins.neonukkitx.command.data.CommandParameter;
import rusplugins.neonukkitx.command.defaults.*;
import rusplugins.neonukkitx.command.simple.*;
...
public class SimpleCommandMap implements CommandMap {
    ...
    private void setDefaultCommands() {
        this.register("neonukkitx", new VersionCommand("version"));
        this.register("neonukkitx", new TpsCommand("tps"));
        this.register("neonukkitx", new PingCommand("ping"));
    ...
    public void registerSimpleCommands(Object object) {
        for (Method method : object.getClass().getDeclaredMethods()) {
            rusplugins.neonukkitx.command.simple.Command def = method.getAnnotation(rusplugins.neonukkitx.command.simple.Command.class);
            if (def != null) {
