...
import rusplugins.neonukkitx.block.BlockCactus;
import rusplugins.neonukkitx.block.BlockMagma;
import rusplugins.neonukkitx.entity.mob.*;
import rusplugins.neonukkitx.entity.passive.EntityIronGolem;
import rusplugins.neonukkitx.entity.passive.EntitySkeletonHorse;
import rusplugins.neonukkitx.entity.projectile.EntityProjectile;
import rusplugins.neonukkitx.entity.weather.EntityWeather;
...
import rusplugins.neonukkitx.item.ItemTurtleShell;
...
import rusplugins.neonukkitx.utils.BlockIterator;
import rusplugins.neonukkitx.entity.ai.EntityAI;
...
public abstract class EntityLiving extends Entity implements EntityDamageable {
                ...
                if (baseEntity.getLastDamageCause() instanceof EntityDamageByEntityEvent) {
                    ...
                    if (damager instanceof Player) {
                        ...
                        if (!this.dropsOnNaturalDeath()) {
                            for (rusplugins.neonukkitx.item.Item item : ev.getDrops()) {
    ...
    public boolean entityBaseTick(int tickDiff) {
        ...
        if (this.entityAI != null) {
            this.entityAI.onUpdate((int) this.level.getCurrentTick());
        }
