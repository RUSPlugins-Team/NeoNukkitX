...
import rusplugins.neonukkitx.network.protocol.AvailableEntityIdentifiersPacket;
import rusplugins.neonukkitx.network.protocol.BatchPacket;
...
public class EntityManager {
    ...
    private EntityManager() {
        try (InputStream inputStream = NeoNukkitX.class.getClassLoader().getResourceAsStream("entity_identifiers.dat")) {
