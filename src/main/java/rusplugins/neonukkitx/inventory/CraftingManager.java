...
import rusplugins.neonukkitx.network.protocol.CraftingDataPacket;
import rusplugins.neonukkitx.utils.*;
import rusplugins.neonukkitx.utils.material.tags.MaterialTags;
                            ...
                            for (Map.Entry<String, Map<String, Object>> ingredientEntry : input.entrySet()) {
                                ...
                                if (!"default".equals(type)) {
                                    if ("item_tag".equals(type)) {
                                        ...
                                        if (NeoNukkitX.DEBUG > 1 && inputItem == null) {
