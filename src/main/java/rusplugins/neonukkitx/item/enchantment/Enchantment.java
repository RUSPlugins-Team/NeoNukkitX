...
import rusplugins.neonukkitx.item.enchantment.bow.EnchantmentBowFlame;
import rusplugins.neonukkitx.item.enchantment.bow.EnchantmentBowInfinity;
import rusplugins.neonukkitx.item.enchantment.bow.EnchantmentBowKnockback;
import rusplugins.neonukkitx.item.enchantment.bow.EnchantmentBowPower;
import rusplugins.neonukkitx.item.enchantment.crossbow.EnchantmentCrossbowMultishot;
import rusplugins.neonukkitx.item.enchantment.crossbow.EnchantmentCrossbowPiercing;
import rusplugins.neonukkitx.item.enchantment.crossbow.EnchantmentCrossbowQuickCharge;
import rusplugins.neonukkitx.item.enchantment.damage.EnchantmentDamageAll;
import rusplugins.neonukkitx.item.enchantment.damage.EnchantmentDamageArthropods;
import rusplugins.neonukkitx.item.enchantment.damage.EnchantmentDamageSmite;
import rusplugins.neonukkitx.item.enchantment.loot.EnchantmentLootDigging;
import rusplugins.neonukkitx.item.enchantment.loot.EnchantmentLootFishing;
import rusplugins.neonukkitx.item.enchantment.loot.EnchantmentLootWeapon;
import rusplugins.neonukkitx.item.enchantment.mace.EnchantmentMaceBreach;
import rusplugins.neonukkitx.item.enchantment.mace.EnchantmentMaceDensity;
import rusplugins.neonukkitx.item.enchantment.mace.EnchantmentMaceWindBurst;
import rusplugins.neonukkitx.item.enchantment.protection.*;
import rusplugins.neonukkitx.item.enchantment.trident.EnchantmentTridentChanneling;
import rusplugins.neonukkitx.item.enchantment.trident.EnchantmentTridentImpaling;
import rusplugins.neonukkitx.item.enchantment.trident.EnchantmentTridentLoyalty;
import rusplugins.neonukkitx.item.enchantment.trident.EnchantmentTridentRiptide;
