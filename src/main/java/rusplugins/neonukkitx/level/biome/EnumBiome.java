package rusplugins.neonukkitx.level.biome;

import rusplugins.neonukkitx.level.biome.impl.EndBiome;
import rusplugins.neonukkitx.level.biome.impl.HellBiome;
import rusplugins.neonukkitx.level.biome.impl.beach.BeachBiome;
import rusplugins.neonukkitx.level.biome.impl.beach.ColdBeachBiome;
import rusplugins.neonukkitx.level.biome.impl.desert.DesertBiome;
import rusplugins.neonukkitx.level.biome.impl.desert.DesertHillsBiome;
import rusplugins.neonukkitx.level.biome.impl.desert.DesertMBiome;
import rusplugins.neonukkitx.level.biome.impl.extremehills.*;
import rusplugins.neonukkitx.level.biome.impl.forest.FlowerForestBiome;
import rusplugins.neonukkitx.level.biome.impl.forest.ForestBiome;
import rusplugins.neonukkitx.level.biome.impl.forest.ForestHillsBiome;
import rusplugins.neonukkitx.level.biome.impl.iceplains.IcePlainsBiome;
import rusplugins.neonukkitx.level.biome.impl.iceplains.IcePlainsHillsBiome;
import rusplugins.neonukkitx.level.biome.impl.iceplains.IcePlainsSpikesBiome;
import rusplugins.neonukkitx.level.biome.impl.jungle.*;
import rusplugins.neonukkitx.level.biome.impl.mesa.*;
import rusplugins.neonukkitx.level.biome.impl.mushroom.MushroomIslandBiome;
import rusplugins.neonukkitx.level.biome.impl.mushroom.MushroomIslandShoreBiome;
import rusplugins.neonukkitx.level.biome.impl.nether.BasaltDeltasBiome;
import rusplugins.neonukkitx.level.biome.impl.nether.CrimsonForestBiome;
import rusplugins.neonukkitx.level.biome.impl.nether.SoulSandValleyBiome;
import rusplugins.neonukkitx.level.biome.impl.nether.WarpedForestBiome;
import rusplugins.neonukkitx.level.biome.impl.ocean.*;
import rusplugins.neonukkitx.level.biome.impl.plains.PlainsBiome;
import rusplugins.neonukkitx.level.biome.impl.plains.SunflowerPlainsBiome;
import rusplugins.neonukkitx.level.biome.impl.river.FrozenRiverBiome;
import rusplugins.neonukkitx.level.biome.impl.river.RiverBiome;
import rusplugins.neonukkitx.level.biome.impl.roofedforest.RoofedForestBiome;
import rusplugins.neonukkitx.level.biome.impl.roofedforest.RoofedForestMBiome;
import rusplugins.neonukkitx.level.biome.impl.savanna.SavannaBiome;
import rusplugins.neonukkitx.level.biome.impl.savanna.SavannaMBiome;
import rusplugins.neonukkitx.level.biome.impl.savanna.SavannaPlateauBiome;
import rusplugins.neonukkitx.level.biome.impl.savanna.SavannaPlateauMBiome;
import rusplugins.neonukkitx.level.biome.impl.swamp.SwampBiome;
import rusplugins.neonukkitx.level.biome.impl.swamp.SwamplandMBiome;
import rusplugins.neonukkitx.level.biome.impl.taiga.*;
