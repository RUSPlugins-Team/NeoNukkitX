package rusplugins.neonukkitx.level.biome.impl.forest;
...
import rusplugins.neonukkitx.level.generator.populator.impl.PopulatorFallenTree;
...
public class ForestBiome extends GrassyBiome {
    ...
    public ForestBiome(int type) {
        ...
        trees.setBaseAmount(type == TYPE_NORMAL ? 5 : 15);
