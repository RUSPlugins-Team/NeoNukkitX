package rusplugins.neonukkitx.level.format.anvil;
...
import rusplugins.neonukkitx.level.format.anvil.palette.BiomePalette;
...
public class Chunk extends BaseChunk {
    ...
    public Chunk(LevelProvider level, CompoundTag nbt) {
        ...
        if (nbt == null) {
            ...
            this.sections = new rusplugins.neonukkitx.level.format.ChunkSection[16];
            ...
            for (CompoundTag entryNBT : updateEntries.getAll()) {
                ...
                try {
                    ...
                    if (tag instanceof StringTag) {
                        ...
                        Class<? extends Block> clazz = (Class<? extends Block>) Class.forName("rusplugins.neonukkitx.block." + name);
    ...
    private CompoundTag chunkNBT() {
        ...
        for (rusplugins.neonukkitx.level.format.ChunkSection section : this.getSections()) {
    ...
    public int getBlockSkyLight(int x, int y, int z) {
        rusplugins.neonukkitx.level.format.ChunkSection section = this.sections[y >> 4];
        if (section instanceof rusplugins.neonukkitx.level.format.anvil.ChunkSection) {
            rusplugins.neonukkitx.level.format.anvil.ChunkSection anvilSection = (rusplugins.neonukkitx.level.format.anvil.ChunkSection) section;
    ...
    public boolean compress() {
        ...
        for (rusplugins.neonukkitx.level.format.ChunkSection section : getSections()) {
