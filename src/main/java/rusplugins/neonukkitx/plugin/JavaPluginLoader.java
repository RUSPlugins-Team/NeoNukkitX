...
import rusplugins.neonukkitx.event.plugin.PluginDisableEvent;
import rusplugins.neonukkitx.event.plugin.PluginEnableEvent;
...
public class JavaPluginLoader implements PluginLoader {
    ...
    public PluginDescription getPluginDescription(File file) {
        try (JarFile jar = new JarFile(file)) {
            JarEntry entry = jar.getJarEntry("neonukkitx.yml");
            if (entry == null) {
