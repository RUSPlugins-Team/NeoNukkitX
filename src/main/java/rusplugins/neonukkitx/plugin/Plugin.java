...
import rusplugins.neonukkitx.command.CommandExecutor;
import rusplugins.neonukkitx.utils.Config;
 ...
 * <p>
 * 对于插件作者，我们建议让插件主类继承{@link rusplugins.neonukkitx.plugin.PluginBase}类，而不是实现这个接口。<br>
 * For plugin developers: it's recommended to use {@link rusplugins.neonukkitx.plugin.PluginBase} for an actual plugin
 * instead of implement this interface.
 *
 * @author MagicDroidX(code) @ Nukkit Project
 * @author 粉鞋大妈(javadoc) @ Nukkit Project
 * @see rusplugins.neonukkitx.plugin.PluginBase
 * @see rusplugins.neonukkitx.plugin.PluginDescription
 */
public interface Plugin extends CommandExecutor {
     ...
     * <p>
     * 如果需要替换已存在的资源文件，建议使用{@link rusplugins.neonukkitx.plugin.Plugin#saveResource(String, boolean)}<br>
     * If you need to REPLACE an existing resource file, it's recommended
     * to use {@link rusplugins.neonukkitx.plugin.Plugin#saveResource(String, boolean)}.
     *
     ...
     * @see rusplugins.neonukkitx.plugin.Plugin#saveDefaultConfig
     * @see rusplugins.neonukkitx.plugin.Plugin#saveResource(String, boolean)
     */
     ...
     * which is normally named 'resources' and placed in plugin jar file, and copy it into data folder.
     * <p>
     * 如果需要保存默认的资源文件，建议使用{@link rusplugins.neonukkitx.plugin.Plugin#saveResource(String)}<br>
     * If you need to SAVE DEFAULT resource file, it's recommended
     * to use {@link rusplugins.neonukkitx.plugin.Plugin#saveResource(String)}.
     *
     * @param filename 要保存的资源文件名字。<br>The name of the resource file to save.
     * @param replace  是否替换目标文件。<br>if true, Nukkit will replace the target resource file.
     * @return 保存是否成功。<br>true if the saving action is successful.
     * @see rusplugins.neonukkitx.plugin.Plugin#saveResource(String)
     */
    ...
    /**
     * 返回这个Nukkit插件配置文件的{@link rusplugins.neonukkitx.utils.Config}对象。<br>
     * The config file this Nukkit plugin as a {@link rusplugins.neonukkitx.utils.Config} object.
     * <p>
     ...
     * @see rusplugins.neonukkitx.plugin.Plugin#getDataFolder
     */
    Config getConfig();
     ...
     *
     * @see rusplugins.neonukkitx.plugin.Plugin#getDataFolder
     * @see rusplugins.neonukkitx.plugin.Plugin#saveResource
     */
    ...
    /**
     * 返回运行这个插件的服务器的{@link rusplugins.neonukkitx.Server}对象。<br>
     * Gets the server which is running this plugin, and returns as a {@link rusplugins.neonukkitx.Server} object.
     *
     * @see rusplugins.neonukkitx.Server
     */
    Server getServer();
     ...
     *
     * @see rusplugins.neonukkitx.plugin.Plugin#getDescription
     */
    String getName();

    /**
     * 返回这个插件的日志记录器为{@link rusplugins.neonukkitx.plugin.PluginLogger}对象。<br>
     * Returns the logger of this plugin as a {@link rusplugins.neonukkitx.plugin.PluginLogger} object.
     * <p>
     * 使用日志记录器，你可以在控制台和日志文件输出信息。<br>
     * You can use a plugin logger to output messages to the console and log file.
     *
     * @see rusplugins.neonukkitx.plugin.PluginLogger
     */
    PluginLogger getLogger();

    /**
     * 返回这个插件的加载器为{@link rusplugins.neonukkitx.plugin.PluginLoader}对象。<br>
     * Returns the loader of this plugin as a {@link rusplugins.neonukkitx.plugin.PluginLoader} object.
     *
     * @see rusplugins.neonukkitx.plugin.PluginLoader
     */
