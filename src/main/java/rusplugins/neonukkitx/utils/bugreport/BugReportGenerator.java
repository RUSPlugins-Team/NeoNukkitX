package rusplugins.neonukkitx.utils.bugreport;
...
public class BugReportGenerator extends Thread {
    ...
    private String generate() throws IOException {
        File reports = new File(NeoNukkitX.DATA_PATH, "logs/bug_reports");
        ...
        content = content.replace("${NEONUKKITX_VERSION}", NeoNukkitX.VERSION);
